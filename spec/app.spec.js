...
describe("/", () => {
  ...
  describe("/api", () => {
    it("GET: status code 200, serves JSON object containing all available endpoints", () => {
      return request(app)
        .get("/api")
        .expect(200)
        .then(({ body }) => {
    ...
    describe("/articles", () => {
      ...
      it("GET: responds with a status code of 404 when passed an author that does not exist", () => {
        return request(app)
    ...
    it("GET responds with a status code of 404 when passed a topic that does not exist", () => {
      return request(app)
    ...
    it("GET: takes a page query and responds with the articles from that page", () => {
      return request(app)
    ...
    describe("/:article_id", () => {
      ...
      describe("/comments", () => {
        ...
        it("POST: responds with status code 400, when comment object that does not contain all the required keys", () => {
          return request(app)
            .post("/api/articles/1/comments")
            .send({
              username: "lurker"
